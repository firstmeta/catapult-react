...
import { SaveCompanySummary, UploadCompanySummaryImage } from '../actions/company_action';
...
class CompanyCreateSummary extends Component {
  ...
  componentDidMount() {
     this._editor = AlloyEditor.editable("editable", this.props.alloyEditorConfig);
            ...
            <div className="col-md-10 col-md-offset-1 segment add-padding">
              ...
              <div className="row">
                <div className="col-sm-10 col-sm-offset-1">
                  <div id="editable" dangerouslySetInnerHTML={{__html: this.state.template}}>
